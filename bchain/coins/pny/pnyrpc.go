...
// PnYRPC is an interface to JSON-RPC bitcoind service.
type PnYRPC struct {
	*btc.BitcoinRPC
    BitcoinGetChainInfo func() (*bchain.ChainInfo, error)
}

// NewPnYRPC returns new PnYRPC instance.
func NewPnYRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes PnYRPC instance.
func (b *PnYRPC) Initialize() error {
	...
	b.Parser = NewPnYParser(params, b.ChainConfig)
...
type ResGetInfo struct {
	...
	Result struct {
        ...
        ZerocoinSupply  bchain.ZCdenoms    `json:"zPNYsupply"`
	} `json:"result"`
}
...
func (b *PnYRPC) GetNextSuperBlock(nHeight int) int {
...
// PNY adds MoneySupply and ZerocoinSupply to btc implementation
func (b *PnYRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (b *PnYRPC) Findzcserial(serialHex string) (string, error) {
